...
data.push_back("out_out11.hipo");
data.push_back("out_out12.hipo");
data.push_back("out_out13.hipo");
data.push_back("out_out14.hipo");
data.push_back("out_out15.hipo");
data.push_back("out_out16.hipo");
data.push_back("out_out17.hipo");
data.push_back("out_out18.hipo");
// data.push_back("out_out19.hipo");
// data.push_back("out_out20.hipo");
// data.push_back("out_out21.hipo");
  ...
  while(reader.next()==true)
  {
    ...
    if(electron.size()==1 && proton.size()==1 && gamma.size()>=1)
    {
      ...
      { 
        ...
        if (((abs(Egamtest1.E()-g1mc.E())/g1mc.E()) < perc) && (abs(Egamtest1.Theta()-g1mc.Theta())/g1mc.Theta()<perc_theta) && (abs(Egamtest1.Phi()-g1mc.Phi())/g1mc.Phi()<perc))
        {
          g1mc_simi.push_back(k);
        } else {}
        if ((abs(Egamtest1.E()-g2mc.E())/g2mc.E()) < perc && (abs(Egamtest1.Theta()-g2mc.Theta())/g2mc.Theta()<perc_theta) && (abs(Egamtest1.Phi()-g2mc.Phi())/g2mc.Phi()<perc))
        {
          g1mc_simi.push_back(k);
        } else {}
